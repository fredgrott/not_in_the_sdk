...
class AppTheme {
  ...
  static ThemeData themeData(ColorScheme colorScheme, Color focusColor) {
    return ThemeData(
      ...
      focusColor: focusColor, colorScheme: colorScheme.copyWith(background: colorScheme.background),
  ...
  static const TextTheme _textTheme = TextTheme(
    headlineMedium: TextStyle(fontWeight: _bold, fontSize: 28.0),
    headlineSmall: TextStyle(fontWeight: _bold, fontSize: 24.0),
    headlineLarge: TextStyle(fontWeight: _normal, fontSize: 18.0),
    titleMedium: TextStyle(fontWeight: _bold, fontSize: 14.0),
    titleSmall: TextStyle(fontWeight: _normal, fontSize: 14.0),
    labelLarge: TextStyle(fontWeight: _normal, fontSize: 12.0),
  );
}
